...
public class VideoHandler : MonoBehaviour
{
    ...
    public void GetTheVideo(string folder)
    {
        string foldername = Path.Combine(Application.streamingAssetsPath, folder);
    ...
    public void PauseOrPlayTheVideo()
    {
        ...
        if (player.isPlaying)
        {
            GameManager.instance.pauseOrPlayButtonImage.sprite = GameManager.instance.PlaySprite;
            player.Pause(); 
        }
        else
        {
            GameManager.instance.pauseOrPlayButtonImage.sprite = GameManager.instance.PauseSprite;
            player.Play();
        }
    }
}
